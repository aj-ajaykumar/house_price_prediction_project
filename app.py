...
def view_experiment_history():
    experiment_df = Piplile.get_experiments_status()
    context = {
...
def train():
    message = ""
    pipeline = Piplile(config=Configuartion(current_time_stamp=get_current_time_stamp()))
    if not Piplile.experiment.running_status:
