...
# it is used to  return the details in string ex : print(housingException()) gives the messsage
    def __str__(self):
        return self.error_message

# it is used to represent the object Ex: housingException()----> gives housing exception name
